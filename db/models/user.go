...
type User struct {
	...
	Roles    Roles  `boil:"roles" json:"roles" toml:"roles" yaml:"roles"`
...
type whereHelperRoles struct{ field string }

func (w whereHelperRoles) EQ(x Roles) qm.QueryMod  { return qmhelper.Where(w.field, qmhelper.EQ, x) }
func (w whereHelperRoles) NEQ(x Roles) qm.QueryMod { return qmhelper.Where(w.field, qmhelper.NEQ, x) }
func (w whereHelperRoles) LT(x Roles) qm.QueryMod  { return qmhelper.Where(w.field, qmhelper.LT, x) }
func (w whereHelperRoles) LTE(x Roles) qm.QueryMod { return qmhelper.Where(w.field, qmhelper.LTE, x) }
func (w whereHelperRoles) GT(x Roles) qm.QueryMod  { return qmhelper.Where(w.field, qmhelper.GT, x) }
func (w whereHelperRoles) GTE(x Roles) qm.QueryMod { return qmhelper.Where(w.field, qmhelper.GTE, x) }
func (w whereHelperRoles) IN(slice []Roles) qm.QueryMod {
...
func (w whereHelperRoles) NIN(slice []Roles) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var UserWhere = struct {
	...
	Roles:    whereHelperRoles{field: "\"user\".\"roles\""},
...
type userR struct {
	IDOrg *Org `boil:"IDOrg" json:"IDOrg" toml:"IDOrg" yaml:"IDOrg"`
}
...
var (
	userAllColumns            = []string{"user_id", "email", "password", "enabled", "roles", "id"}
	userColumnsWithoutDefault = []string{"user_id", "email", "password", "enabled", "roles", "id"}
...
// IDOrg pointed to by the foreign key.
func (o *User) IDOrg(mods ...qm.QueryMod) orgQuery {
...
// LoadIDOrg allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (userL) LoadIDOrg(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		...
		object.R.IDOrg = foreign
		if foreign.R == nil {
			foreign.R = &orgR{}
		}
		foreign.R.IDUsers = append(foreign.R.IDUsers, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ID == foreign.ID {
				local.R.IDOrg = foreign
				if foreign.R == nil {
					foreign.R = &orgR{}
				}
				foreign.R.IDUsers = append(foreign.R.IDUsers, local)
				break
			}
		}
	}
...
// SetIDOrgG of the user to the related item.
// Sets o.R.IDOrg to related.
// Adds o to related.R.IDUsers.
// Uses the global database handle.
func (o *User) SetIDOrgG(ctx context.Context, insert bool, related *Org) error {
	return o.SetIDOrg(ctx, boil.GetContextDB(), insert, related)
}

// SetIDOrg of the user to the related item.
// Sets o.R.IDOrg to related.
// Adds o to related.R.IDUsers.
func (o *User) SetIDOrg(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Org) error {
	var err error
	if insert {
	...
	if related.R == nil {
		...
		related.R.IDUsers = append(related.R.IDUsers, o)
	}
...
func FindUserG(ctx context.Context, userID string, selectCols ...string) (*User, error) {
...
func UserExistsG(ctx context.Context, userID string) (bool, error) {
